...
<div class="max-w-6xl mx-auto px-6 py-10">
  <div class="grid grid-cols-1 md:grid-cols-2 gap-10 items-start">
    ...
    <div class="space-y-6">
      <div>
        <h1 class="text-3xl font-bold text-gray-800 dark:text-white">Paket Private Trip</h1>
        ...
        <div class="mt-4 inline-flex items-baseline gap-3">
          <div class="text-2xl md:text-3xl font-extrabold text-[#1f3b5a] dark:text-blue-300">
            Rp <span id="hargaSatuan">350000</span> <span class="text-sm font-medium text-gray-500">/ orang</span>
          </div>
        </div>
