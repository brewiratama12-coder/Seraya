...
<section class="max-w-6xl mx-auto px-6 py-10">
    ...
    <div class="grid grid-cols-1 lg:grid-cols-2 gap-10">
        ...
        <div>
            ...
            <!-- Price -->
            <div class="mb-5">
                <p class="line-through text-gray-400 text-sm">Rp 350.000</p>
    ...
    <div class="mt-14">
        ...
        <p class="text-gray-700 dark:text-gray-300 leading-relaxed mb-6">
           Paket Wisata Open Trip merupakan pilihan tepat bagi Anda yang ingin berlibur dengan budget hemat namun tetap mendapatkan pengalaman perjalanan terbaik. Anda akan bergabung dengan para traveler lainnya yang memiliki tujuan dan minat yang sama. Perjalanan dimulai dari titik penjemputan yang telah ditentukan menuju destinasi wisata unggulan sesuai itinerary yang tersedia.
        </p>

        <p class="text-gray-700 dark:text-gray-300 leading-relaxed">
           Dengan bergabung dalam Open Trip, Anda tidak hanya menikmati keindahan alam dan tempat wisata populer, tetapi juga berkesempatan mendapatkan teman baru selama perjalanan. Trip ini sangat cocok bagi Anda yang bepergian sendiri atau bersama pasangan namun tetap ingin suasana seru dan ramai. Kami memberikan pelayanan terbaik serta fasilitas yang nyaman untuk memastikan perjalanan Anda menyenangkan dari awal hingga akhir.
        </p>
    </div>
